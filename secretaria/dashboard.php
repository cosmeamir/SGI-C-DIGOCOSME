...
?>
<div class="app-layout"><?php include __DIR__ . '/../includes/sidebar.php'; ?><main class="content-wrap"><h2 class="mb-3">Dashboard da Secretaria</h2><div class="row g-3"><?php foreach($stats as $k=>$v): ?><div class="col-md-3"><div class="card card-kpi p-2 px-3"><div class="text-muted small"><?= $k ?></div><div class="display-6 fw-bold"><?= $v ?></div></div></div><?php endforeach; ?></div></main></div><?php include __DIR__ . '/../includes/footer.php'; ?>
